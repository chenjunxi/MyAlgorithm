    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < input.length; i++) {
            if (input[i].contains("-")) {
                ...
                int star = Integer.parseInt(num[0]);
        ...
        while (idx < list.size()) {
            ...
            if (list.get(idx + 1) == star + temp) {
                idx++;
                temp++;
                continue;
            } else {
                sb.append(star).append("-").append(list.get(idx));
                star = 0;
                temp = 1;
                if (idx + 1 < list.size()) {
                    sb.append(",");
